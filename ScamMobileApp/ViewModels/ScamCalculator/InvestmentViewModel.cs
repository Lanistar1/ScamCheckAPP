...
namespace ScamMobileApp.ViewModels.ScamCalculator
{
    ...
    {
        public InvestmentViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new InvestmentSecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new InvestmentThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new InvestmentFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new InvestmentLikelyResult());

                    ScamResult = "The Q&A assessment strongly suggests a probable scam. Reliable investments encourage seeking advice from financial experts. Always be cautious and research thoroughly before investing. If in doubt or pressured, consult financial experts and authorities, and consider reporting the situation. Avoid rushing into decisions, especially with investments lacking transparency or making extraordinary promises.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new InvestmentUnlikelyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Is the investment promising extraordinarily high returns with little or no risk? ",
                                    "Is the investment opportunity being aggressively pushed, with pressure to invest immediately?",
                                    "Is the investment promoter or company registered with appropriate regulatory authorities?",
                                    "Have you been asked to keep the investment opportunity confidential or discouraged from seeking advice from financial professionals?"
                                };
