...
namespace ScamMobileApp.ViewModels.ScamCalculator
{
    ...
    {
        public SocialMediaViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new SocialMediaSecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new SocialMedianThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new SocialMediaFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new SocialMediaUnlikelyResult());
