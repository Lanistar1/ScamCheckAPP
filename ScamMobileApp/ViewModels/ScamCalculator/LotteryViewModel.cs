...
namespace ScamMobileApp.ViewModels.ScamCalculator
{
    ...
    {
        public LotteryViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new LotterySecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new LotteryThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new LotteryFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new LotteryLikelyResult());

                    ScamResult = "The Q&A analysis strongly suggests a likely scam. Be cautious of unrealistic prizes without entering contests. Avoid sharing information or money for unearned gifts.  Independently research and contact the organizer through official channels if uncertain. Legitimate prizes won't need payment or data. If uncertain, stay cautious and report before acting.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new LotteryUnlikelyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Did you enter a legitimate contest or lottery that you remember participating in?",
                                    "Are you asked to pay a fee or provide personal information to claim the prize or gift?",
                                    "Is the offer too good to be true, such as winning an unusually large sum of money or an extravagant prize?",
                                    "Are you pressured to act quickly, such as needing to provide payment or personal information immediately to claim the prize?"
                                };
                ...
                { questionAnswer = itemList, comment = UserComment, output = scamlikely, rating = newrating, outputDetails = updatedResult, scamType = "LOTTERY, PRIZE OR FREE GIFTS SCAM" };
