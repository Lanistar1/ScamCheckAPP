...
namespace ScamMobileApp.ViewModels.ScamCalculator
{
    ...
    {
        public BusinessViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new BusinessSecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new BusinessThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new BusinesForthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new BusinessLikelyResult());

                    ScamResult = "The Q&A assessment strongly suggests a potential scam. Watch for odd language or grammar in emails. Verify unexpected requests by contacting the sender through trusted channels. Don't solely trust email information, as BEC scams imitate well. Train employees to spot BEC signs and promote skepticism to prevent falling prey to these complex scams.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new BusinessUnlikelyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Is the request coming from a known and verified email address of a colleague, client, or superior? ",
                                    "Is the request asking for a financial transaction, such as wire transfer or payment, and does it seem out of the ordinary?",
                                    "Is the communication requesting personal information, like employee data, confidential financial details, or login credentials?",
                                    "Is the language used in the email different from the sender's usual communication style, or does the email contain poor grammer, spelling mistakes, errors or inconsistencies?"
                                };
