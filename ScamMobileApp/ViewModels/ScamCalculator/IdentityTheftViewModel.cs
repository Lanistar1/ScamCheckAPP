...
{
    public class IdentityTheftViewModel : BaseViewModel
    {
        public IdentityTheftViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new IdentitySecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new IdentityThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new IdentityFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new IdentityLikeResult());

                    ScamResult = "The Q&A assessment strongly suggests a potential scam. If you suspect identity theft, take quick action. Report to financial institutions, credit bureaus, and affected accounts. Place fraud alerts and monitor closely. Stay proactive with robust passwords, two-factor authentication, and regular financial checks to ward off identity theft scams.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new IdentityUnlikeLyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Have you noticed any unexplained or unauthorized transactions on your financial accounts or credit reports?",
                                    "Did you receive any notifications about changes to your accounts or personal information that you didn't initiate?",
                                    "Have you noticed a sudden drop in your credit score or an increase in credit inquiries you didn't initiate?",
                                    "Are you receiving unexpected bills or statements for accounts you didn't open?"
                                };
                ...
                { questionAnswer = itemList, comment = UserComment, output = scamlikely, rating = newrating, outputDetails = updatedResult, scamType = "Identity Theft Scam" };
