...
{
    public class OnlineShoppingViewmodel : BaseViewModel
    {
        public OnlineShoppingViewmodel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new OnlineShoppingSecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new OnlineShoppingThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new OnlineShoppingFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new OnlineShoppingLikelyResult());

                    ScamResult = "The Q&A assessment strongly suggests a potential scam. Unrealistically low prices and unnecessary details are red flags. Use secure payment methods, avoid unsecured networks, and be skeptical of unsolicited emails or pop-ups. Check bank statements for unauthorized charges. Stay informed and cautious to prevent online shopping scams. Report any doubts promptly.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new OnlineShoppingUnlikelyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Is the website or online seller well-known and reputable, or have you researched reviews and feedback about them?",
                                    "Is the deal or price too good to be true, significantly lower than other reputable retailers?",
                                    "Is the website secure, with 'https://' in the URL and a padlock icon in the address bar?",
                                    "Are you being asked to provide excessive personal or financial information beyond what's necessary for the purchase?"
                                };
                ...
                { questionAnswer = itemList, comment = UserComment, output = scamlikely, rating = newrating, outputDetails = updatedResult, scamType = "Online Shopping Scam" };
