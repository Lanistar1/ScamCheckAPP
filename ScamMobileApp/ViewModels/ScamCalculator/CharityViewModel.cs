...
namespace ScamMobileApp.ViewModels.ScamCalculator
{
    ...
    {
        public CharityViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new CharitySecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new CharityThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new CharityFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new CharityLikelyResult());

                    ScamResult = "The Q&A assessment strongly suggests a probable scam. Before donating, research the charity thoroughly, verify its legitimacy through official websites, and read reviews or evaluations from trusted sources. Avoid sharing personal or financial information with unsolicited callers or messages.By taking these precautions, you can ensure your donations go to genuine and reputable charitable organizations.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new CharityUnlikelyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Is the charity registered with relevant authorities and have a proven track record of legitimate work? ",
                                    "Is the request for a donation coming from an official, recognized communication channel of the charity?",
                                    "Does the charity provide clear and detailed information about their mission, programs, and how the donations will be used? ",
                                    "Are they pressuring you to donate immediately or claiming that your donation is urgently needed?"
                                };
                ...
                { questionAnswer = itemList, comment = UserComment, output = scamlikely, rating = newrating, outputDetails = updatedResult, scamType = "Charity Scams" };
