...
namespace ScamMobileApp.ViewModels.ScamCalculator
{
    ...
    {
        public GiftCardViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new GiftCardSecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new GiftCardThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new GiftCardFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new GiftCardLikelyQuestion());

                    ScamResult = "The Q&A assessment strongly suggests a probable scam. Legitimate parties usually don't ask for gift card payments. If doubtful, verify and use verified channels to contact them. Being cautious and informed is crucial to guard against gift card scams.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new GiftCardUnlikelyQuestion());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Is the request for payment or contribution specifically asking for gift cards as the preferred method?",
                                    "Is the request unexpected or coming from an unfamiliar source?",
                                    "Is the request urging you to provide the gift card codes or PIN numbers via phone, email, or messaging?",
                                    "Is the request creating a sense of urgency or fear, pressuring you to act quickly?"
                                };
                ...
                { questionAnswer = itemList, comment = UserComment, output = scamlikely, rating = newrating, outputDetails = updatedResult, scamType = "Gift card Scams" };
