...
{
    public class PhishingViewModel : BaseViewModel
    {
        public PhishingViewModel(INavigation navigation)
        {
        ...
        private async Task FirstQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new PHishingSecondQuestion());
        ...
        private async Task SecondQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new PhishingThirdQuestion());
        ...
        private async Task ThirdQuestionCommandExecute()
        {
            ...
            await Navigation.PushAsync(new PhishingFourthQuestion());
        ...
        private async Task ScamCalculatorCommandExecute()
        {
            try
            {
                ...
                if (newResult > 25)
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new PhishingLikelyResult());

                    ScamResult = "The Q&A assessment strongly suggests a high likelihood of the situation being a scam.  Legitimate entities usually avoid seeking personal details via email.  Phishing emails may request personal data like passwords or finances as security but never share such details through email. Stay informed about common tactics and verify questionable emails through official channels before acting.";
                ...
                else
                {
                    ...
                    Application.Current.MainPage = new NavigationPage(new PhishingUnlikelyResult());
        ...
        public async Task PostFeedbackCommandExecute()
        {
            try
            {
                ...
                string[] items = { "Is the email or message from a familiar sender or organization that you regularly interact with? ",
                                    "Does the email request personal information, like passwords, Social Security numbers, or credit card details?",
                                    "Does the email contain urgent or threatening language, asking you to take immediate action?",
                                    "Are there any suspicious links or attachments in the email, especially if they redirect to unfamiliar websites? "
                                };
                ...
                { questionAnswer = itemList, comment = UserComment, output = scamlikely, rating = newrating, outputDetails = updatedResult, scamType = "Phishing (Email) Scam" };
